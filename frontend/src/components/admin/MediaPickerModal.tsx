        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl h-[85vh] flex flex-col overflow-hidden">
                ...
                <div className="flex items-center justify-between p-4 border-b border-gray-200">
                    <h2 className="text-xl font-semibold text-gray-800">Sélectionner un média</h2>
                ...
                <div className="flex items-center justify-between p-4 border-b border-gray-100 bg-gray-50/50">
                    <div className="flex gap-4">
                        ...
                        <Button 
                            ...
                            disabled={uploading}
                            className="bg-[#2271b1] hover:bg-[#135e96] text-white h-9"
                        >
                    ...
                    <div className="relative">
                        <input 
                            ...
                            className="pl-8 pr-3 py-1.5 border border-gray-300 rounded-md text-sm outline-none focus:border-[#2271b1] w-64"
                        />
                ...
                <div className="flex-1 flex overflow-hidden">
                            ...
                            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-8 gap-3">
                                {filteredItems.map(item => (
                                    <div 
                                        ...
                                        className={`aspect-square relative cursor-pointer border-2 bg-white flex flex-col items-center justify-center overflow-hidden
                                    ...
                                    >
                                        ...
                                        <div className="absolute bottom-0 left-0 right-0 bg-white/95 text-gray-700 text-[10px] p-1 px-1.5 truncate text-center font-medium border-t border-gray-100">
                                            {item.title}
                                        </div>
                    ...
                    {/* Sidebar Details */}
                    {selectedItem && (
                        <div className="w-72 bg-gray-50 border-l border-gray-200 p-4 flex flex-col overflow-y-auto">
                            <h3 className="font-semibold text-gray-800 mb-4 pb-2 border-b">Détails du fichier</h3>
                            <div className="aspect-video bg-gray-200 mb-4 flex items-center justify-center border border-gray-300 rounded overflow-hidden">
                            ...
                            <div className="space-y-3 details-text text-sm flex-1">
                                <div><span className="text-gray-500 block text-xs uppercase font-bold">Nom du fichier</span> <span className="break-all">{selectedItem.title}</span></div>
                                <div><span className="text-gray-500 block text-xs uppercase font-bold">Type de fichier</span> <span className="capitalize">{selectedItem.file_type}</span></div>
                                <div><span className="text-gray-500 block text-xs uppercase font-bold">Taille</span> {selectedItem.formatted_size}</div>
                            </div>
                        </div>
                    )}
                </div>
                ...
                <div className="p-4 border-t border-gray-200 flex justify-end gap-3 bg-white">
                    ...
                    <Button 
                        ...
                        className="bg-[#2271b1] hover:bg-[#135e96] text-white px-6 font-semibold"
                    >
                        Insérer
                    </Button>
                </div>
            ...
            <style>{`
            .details-text div { margin-bottom: 12px; }
            `}</style>
        </div>
    );
};
