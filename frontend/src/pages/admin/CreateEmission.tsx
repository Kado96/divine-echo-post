            ...
            <div className="max-w-6xl mx-auto">
                <header className="flex flex-col gap-4 mb-8">
                    ...
                    <div className="flex items-center justify-between">
                        <h1 className="text-2xl font-bold text-[#1d2327]">{t("admin.emissions_page.create_title")}</h1>
                        <Button
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <input
                            ...
                            type="text"
                            placeholder={t("admin.emissions_page.form.title")}
                            ...
                            <div className="flex items-center justify-between mb-4">
                                <label htmlFor="emission-media-source" className="text-sm font-semibold text-gray-700 cursor-pointer">
                                    {(formData.content_type === "youtube" || (formData.content_type === "video" && formData.content_url.includes("youtube.com")))
                                        ? t("admin.emissions_page.form.url")
                                        : (formData.content_type === "video" ? t("admin.emissions_page.form.file") : t("admin.emissions_page.form.file"))
                                    }
                                </label>
                            ...
                            {(formData.content_type === "youtube" || formData.content_type === "video") ? (
                                <div className="space-y-4">
                                    <input
                                        ...
                                        placeholder={t("admin.emissions_page.form.url_placeholder")}
                    ...
                    <div className="w-full lg:w-[280px] space-y-6">
                        ...
                        <div className="bg-white border border-border shadow-sm">
                            ...
                            <div className="p-3 bg-gray-50/50 border-t border-border flex items-center justify-end">
                                ...
                                >
                                    {t("admin.emissions_page.form.publish")}
                                </Button>
                            </div>
                        </div>
