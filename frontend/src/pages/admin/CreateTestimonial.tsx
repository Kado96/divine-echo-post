        ...
        <AdminLayout>
            <div className="max-w-4xl mx-auto">
                <header className="flex flex-col gap-4 mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-[#1d2327]">💬 {t("admin.testimonials_page.create_title")}</h1>
                </header>
                ...
                <div className="mt-8 p-4 bg-blue-50 border border-blue-100 rounded-xl text-blue-600 text-xs flex items-center gap-3">
                    <Star className="w-5 h-5 shrink-0" />
                    <p>{t("admin.testimonials_page.form.info_star")}</p>
                </div>
            </div>
        </AdminLayout>
    );
